...
RSpec.describe "supervisor_mailer/weekly_digest", type: :view do
  ...
  context "when there are successful and unsuccessful contacts" do
    before(:each) do
      ...
      create_list :case_contact, 2, creator: volunteer, casa_case: casa_case, contact_made: false, occurred_at: Time.zone.today - 6.days
      @case_contact = create :case_contact, creator: volunteer, casa_case: casa_case, contact_made: true, occurred_at: Time.zone.today - 6.days, contact_topic_answers: [contact_topic_answer_1, contact_topic_answer_2]
