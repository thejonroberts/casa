...
RSpec.describe "casa_org/edit", type: :view do
  ...
  context "with a template uploaded" do
    it "renders a prompt to download current template" do
      ...
      organization.court_report_template.attach(io: File.open(Rails.root.join("app/documents/templates/default_report_template.docx").to_s), filename: 'default_report_template
