  ...
  describe "POST /create" do
    ...
    context "when successfully" do
      ...
      it "generates correct defaults during creation" do
        ...
        expect(casa_org.contact_topics.map(&:question)).to eq contact_topics.pluck("question")
        expect(casa_org.contact_topics.map(&:details)).to eq contact_topics.pluck("details")
