...
RSpec.describe UserDecorator do
  ...
  describe "#formatted_created_at" do
    ...
    it "returns the correctly formatted date" do
      user.update(created_at: Time.zone.local(2023, 5, 1, 12, 0, 0))
  ...
  describe "#formatted_updated_at" do
    context "when using the 'default'format string"
    it "returns the correctly formatted date" do
      user.update(updated_at: Time.zone.local(2023, 5, 1, 12, 0, 0))
  ...
  describe "#formatted_current_sign_in_at" do
    context "when using the 'default'format string"
    it "returns the correctly formatted date" do
      user.update(current_sign_in_at: Time.zone.local(2023, 5, 1, 12, 0, 0))
  ...
  describe "#formatted_invitation_accepted_at" do
    context "when using the 'default'format string"
    it "returns the correctly formatted date" do
      user.update(invitation_accepted_at: Time.zone.local(2023, 5, 1, 12, 0, 0))
  ...
  describe "#formatted_reset_password_sent_at" do
    context "when using the 'default'format string"
    it "returns the correctly formatted date" do
      user.update(reset_password_sent_at: Time.zone.local(2023, 5, 1, 12, 0, 0))
  ...
  describe "#formatted_invitation_sent_at" do
    context "when using the 'default'format string"
    it "returns the correctly formatted date" do
      user.update(invitation_sent_at: Time.zone.local(2023, 5, 1, 12, 0, 0))
